...
function twentyten_setup() {
	...
	add_image_size( 'carousel', 360, 478, true );
...
function twentyten_continue_reading_link() {
	return ' <a class="continue" href="'. get_permalink( get_the_ID() ) . '">Continue&raquo;</a>';
}
...
function twentyten_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			<span><?php echo get_comment_author_link() ?></span> writes
...
function my_search_form( $form ) {
    ...
    $form = '<div id="search-form-container" class="clearfix widget_search">
	<form method="get" id="searchform" action="' . get_bloginfo('url') . '">
		<label class="hidden" for="s">' . __('Search:') . '</label>
		<input type="text" value="' . get_search_query() . '" name="s" id="s" placeholder="Search" />
		<input type="image" id="searchsubmit" src="' . get_bloginfo('template_directory') . '/images/search.gif" value="GO" />
	</form>
	</div>';
